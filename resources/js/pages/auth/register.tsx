        ...
        <div className="scanlines flex min-h-screen items-center justify-center bg-[#080808]">
            ...
            <div className="w-full max-w-sm px-4">
                <div className="mb-8 text-center">
                    <div className="mb-1 text-[10px] tracking-[0.4em] text-[#333]">[ NOUVEAU COMPTE ]</div>
                    <h1 className="cursor-blink text-2xl font-bold tracking-[0.2em] text-[#00ff41]">SEVEN</h1>
                    <div className="mt-1 text-[10px] tracking-widest text-[#444]">CODE D'AFFILIATION REQUIS</div>
                </div>
                ...
                <div className="border border-[#1e1e1e] bg-[#0d0d0d] p-6">
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        <div>
                            ...
                            />
                            {errors.username && <p className="mt-1 text-[10px] text-[#cc0000]">{errors.username}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {errors.groupe && <p className="mt-1 text-[10px] text-[#cc0000]">{errors.groupe}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                            />
                            {errors.password && <p className="mt-1 text-[10px] text-[#cc0000]">{errors.password}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.password_confirmation && (
                                <p className="mt-1 text-[10px] text-[#cc0000]">{errors.password_confirmation}</p>
                            )}
                        </div>

                        <div>
                            <label className="mb-1 block text-[10px] uppercase tracking-widest text-[#00ff41]">
                                Code d'affiliation
                            </label>
                            <input
                                type="text"
                                ...
                                className="seven-input w-full px-3 py-2 font-mono text-sm uppercase tracking-widest text-[#00ff41]"
                                placeholder="XXXX-XXXX"
                            />
                            {errors.code_affiliation && (
                                <p className="mt-1 text-[10px] text-[#cc0000]">{errors.code_affiliation}</p>
                            )}
                        </div>
                ...
                <div className="mt-4 text-center text-[10px] text-[#333]">
                    Déjà un compte ?{' '}
                    <Link href={route('login')} className="text-[#555] underline underline-offset-2 hover:text-[#00ff41]">
                        se connecter
                    </Link>
                </div>
            </div>
